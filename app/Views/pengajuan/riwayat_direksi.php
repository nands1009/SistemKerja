...
<head>
    ...
    <title>Riwayat Pengajuan Direksi</title>
    <style>
        body {
                ...
                foreach ($riwayat_penghargaan as $penghargaan): ?>
                    <tr>
                        ...
                        <td><?= $penghargaan['status']; ?></td>
                         <td><?php if ($penghargaan['status'] == 'Approved HRD'): ?>
                                <a href="<?= site_url('/pengajuan/riwayat_pengajuan/' . $penghargaan['id'] . '/penghargaan'); ?>">Disetujui</a>
                                <form action="<?= site_url('/pengajuan/reject_direksi/' . $penghargaan['id'] . '/penghargaan'); ?>" method="post">
            ...
            <tbody>
                ...
                <?php foreach ($riwayat_sp as $sp): ?>
                    <tr>
                        ...
                        <td><?php if ($sp['status'] == 'Approved HRD'): ?>
                                <a href="<?= site_url('/pengajuan/riwayat_pengajuan/' . $sp['id'] . '/sp'); ?>">Disetujui</a>
                                <form action="<?= site_url('/pengajuan/reject_direksi/' . $sp['id'] . '/sp'); ?>" method="post">
                                    <textarea name="catatan_penolakan" rows="3" placeholder="Alasan Penolakan" required></textarea><br>
                                    <button type="submit" class="delete-button">Tolak Pengajuan</button>
                                </form>
                            <?php endif; ?>
...
let currentPageSP = 1;
const rowsPerPage = 2; // Menentukan jumlah baris per halaman
