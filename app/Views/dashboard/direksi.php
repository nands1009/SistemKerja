        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="/direksi/rekap_laporan" class="waves-effect waves-dark"><i class="fa fa-desktop"></i> Rekap Laporan Kerja</a></li>
                    <li><a href="/direksi/rekap_penilaian" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Rekap Penilaian</a></li>
                    <li><a href="/direksi/penilaian_manager" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Penilaian</a></li>
                    <li><a href="/pengajuan/riwayat_direksi" class="waves-effect waves-dark"><i class="fa fa-desktop"></i> Permintaan Persetujuan</a></li>
                    </ul>
                </li>
                </ul>
            </div>
