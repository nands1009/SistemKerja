        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="/laporan_kerja_hrd/create" class="waves-effect waves-dark"><i class="fa fa-desktop"></i>Input Laporan Kerja</a></li>
                    <li><a href="/laporan_kerja_hrd/riwayat" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Riwayat Laporan Kerja</a></li>
                    <li><a href="/rencana-kerja-hrd/input" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Rencana Kerja</a></li>
                    <li><a href="/rencana-kerja-hrd/riwayat" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Riwayat Rencana Kerja</a></li>
                    <li><a href="/approval-hrd" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Persetujuan Laporan Kerja</a></li>
                    <li><a href="/penilaian-hrd" class="waves-effect waves-dark"><i class="fa fa-desktop"></i> Penilaian</a></li>
                    <li><a href="/pengajuan-hrd/ajukan" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Pengajuan Penghargaan atau SP</a></li>
                    <li><a href="/pengajuan-hrd/riwayat_hrd" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Approvel Pengajuan Penghargaan dan SP</a></li>
                    <li><a href="/pengajuan-hrd/riwayat-pengajuan-hrd" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Riwayat Pengajuan</a></li>
                    <li><a href="/riwayat-penilaian-hrd" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Riwayat Penilaian</a></li>
                </ul>
                </li>
                </ul>
            </div>
