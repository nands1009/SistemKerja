    ...
    <div class="container-card-sp">
            ...
            <table class="min-w-full table-auto">
                ...
                <tbody>
                    <h1 class="sp">
                        ...
                        <span class="spterima">SURAT PERINGATAN</span>
                    </h1>
                    <h1 class="sp">
                        <p id="rejected"><?= $penghargaanapproved; ?></p>
                        <span class="sptolak">PENGHARGAAN</span>
                    </h1>
                </tbody>
            </table>
        </div>
        <div class="card-footer-sp bg-transparent border-success">
            <div class="working-sp">
                <p>
                    <span class="jumalah-sp">Notifikasi Untuk APPROVED </span>
                </p>
            </div>
        </div>
    </div>
