    ...
    <div class="container-card-sp">
            ...
            <table class="min-w-full table-auto">
                ...
                <tbody>
                    <h1 class="sp">
                        ...
                        <p> <?= $sppegawai; ?><i class="fa-solid fa-file-exclamation"></i></i></p>
                    </h1>
                </tbody>
            </table>
        </div>
        <div class="card-footer-sp bg-transparent border-success">
            <div class="working-sp">
                <p>
                    <span class="jumalah-sp">SURAT PERINGATAN </span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container-card-penghargaan">
            ...
            <table class="min-w-full table-auto">
                ...
                <tbody>
                    <h1 class="penghargaan">
                        ...
                        <p> <?= $penghargaanpegawai; ?><i class="fa-solid fa-file-exclamation"></i></i></p>
                    </h1>
                </tbody>
            </table>
        </div>
        <div class="card-footer-penghargaan bg-transparent border-success">
            <div class="working-penghargaan">
                <p>
                    <span class="jumalah-penghargaan">SURAT PENGHARGAAN </span>
                </p>
            </div>
        </div>
    </div>
