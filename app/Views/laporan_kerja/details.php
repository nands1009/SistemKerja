                ...
                foreach ($laporan as $row) : ?>
                    <div class="card">
                        ...
                        <div class="card-content">
                            <p><strong>Nama:</strong> <?= esc($row['username']) ?></p><br>
                            <p><strong>Judul laporan:</strong> <?= esc($row['judul']) ?></p><br>
                            <p><strong>Divisi:</strong> <?= esc($row['divisi']) ?></p><br>
                            <p><strong>Jabatan:</strong> <?= esc($row['role']) ?></p><br>
                            <p><strong>Deskripsi:</strong> <?= esc($row['deskripsi']) ?></p><br>
                            <p><strong>Status Project:</strong> <?= esc($row['status']) ?></p><br>
                            <p class="status"><strong>Status Approval:</strong> <?= esc($row['status_approval']) ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else : ?>
                <p style="text-align: center; width: 100%;">No Data Available</p>
            <?php endif; ?>
        </div>
    </div>
</body>
