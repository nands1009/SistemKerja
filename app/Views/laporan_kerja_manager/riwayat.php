...
<body>
            ...
            <div class="table-container">
                <table id="laporanTable">
                    ...
                    <tbody>
                        ...
                        <?php else : ?>
                        <?php endif; ?>
                        <?php if (!empty($laporan_approved)) : ?>
                            <?php $no;
                            foreach ($laporan_approved as $row) : ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= esc($row['tanggal']) ?></td>
                                    <td><?= esc($row['username']) ?></td>
    ...
    <script>
        ...
        function openModal(id) {
            ...
            xhr.open("GET", "<?= site_url('laporan_kerja_manager/edit/') ?>" + id, true);
            xhr.onload = function() {
                if (xhr.status == 200) {
        ...
        function openModalDetail(id) {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "<?= site_url('laporan_kerja_manager/details/') ?>" + id, true);
            xhr.onload = function() {
                if (xhr.status == 200) {
    ...
    <script src="/js/laporan_kerja_manager.js"></script>
</body>
