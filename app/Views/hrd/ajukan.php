    ...
    <div class="container-table">
        <div class="container">
            ...
            <div class="form-container">
                ...
                <form action="<?= site_url('/pengajuan/submitPenghargaanhrd'); ?>" method="post" class="form-section">
                ...
                <form action="<?= site_url('/pengajuan/submitSPHRD'); ?>" method="post" class="form-section">
