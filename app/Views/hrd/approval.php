        ...
        <div class="table-container">
            <table id="reportTable">
                <thead>
                    <tr>
                        <th>No</th>
                        <th id="tanggal">Tanggal Laporan</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($item['status_approval'] == 'Pending'): ?>
                                    ...
                                    <a href="<?= site_url('approval/approvehrd/' . $item['laporan_ID']); ?>"
                                    ...
                                    <form action="<?= site_url('approval/rejecthrd/' . $item['laporan_ID']); ?>" method="post" id="reject-form-<?= $item['laporan_ID']; ?>">
