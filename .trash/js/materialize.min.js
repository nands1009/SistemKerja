    ...
    a.fn.collapsible = function(b) {
        ...
        this.each(function() {
            function c(b) {
                ...
                j.not(b).parent().children(".collapsible-body").stop(!0, !1).each(function() {
        ...
        init: function(c) {
            ...
            this.each(function() {
                ...
                a(document).on("click.modalTrigger", 'a[href="#' + f + '"], [data-target="' + f + '"]', function(b) {
                    c.starting_top = (a(this).offset().top - a(window).scrollTop()) / 1.15,
                    h(a(this)),
                    b.preventDefault()
                }),
...
function(a) {
    var b = {
        init: function(b) {
            ...
            return b = a.extend(c, b),
            this.each(function() {
                var c, d, e = a(this), f = (a(window).width(),
                e.find("li.tab a")), g = e.width(), h = Math.max(g, e[0].scrollWidth) / f.length, i = 0, j = function(a) {
    ...
    var b = {
        init: function(b) {
            ...
            a(this).each(function() {
                ...
                a("body").append(e)) : e = a(),
                "left" == b.edge ? (d.css("transform", "translateX(-100%)"),
                e.css({
                    left: 0
                })) : (d.addClass("right-aligned").css("transform", "translateX(100%)"),
                e.css({
                    right: 0
                })),
                ...
                e.hammer({
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        ...
                        g.width(j),
                        0 === i.length && (i = a('<div id="sidenav-overlay"></div>'),
                        ...
                        "left" === b.edge)
                            e < b.menuWidth / 2 ? h = !1 : e >= b.menuWidth / 2 && (h = !0),
                            d.css("transform", "translateX(" + (e - b.menuWidth) + "px)");
                        else {
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        ...
                        0 > l && (l = 0),
                        g = !1,
                        "left" === b.edge ? h && .3 >= i || -.5 > i ? (0 !== k && d.velocity({
                            translateX: [0, k]
                        }, {
                            duration: 300,
                            queue: !1,
                ...
                var i = a('<ul id="select-options-' + g + '" class="dropdown-content select-dropdown ' + (e ? "multiple-select-dropdown" : "") + '"></ul>')
                  ...
                  , n = function(b, c, d) {
                    ...
                    if (g) {
                        var j = "";
                        return h && (j = ' class="' + h + '"'),
                        "multiple" === d ? i.append(a('<li class="' + e + '"><img alt="" src="' + g + '"' + j + '><span><input type="checkbox"' + e + "/><label></label>" + c.html() + "</span></li>")) : i.append(a('<li class="' + e + f + '"><img alt="" src="' + g + '"' + j + "><span>" + c.html() + "</span></li>")),
                        !0
                    }
    ...
    a.fn.material_chip = function(d) {
        ...
        this.handleEvents = function() {
            ...
            e.$document.off("keydown.chips-add", b.CHIPS + " " + b.INPUT).on("keydown.chips-add", b.CHIPS + " " + b.INPUT, function(c) {
                ...
                void d.val("")) : 8 !== c.keyCode && 37 !== c.keyCode || "" !== d.val() || !g ? void 0 : (e.selectChip(g - 1, f),
                void d.blur())
            }),
        ...
        this.addChip = function(b, c) {
            if (e.isValid(c, b)) {
                for (var d = e.renderChip(b), f = [], g = c.data("chips"), h = 0; h < g.length; h++)
                    f.push(g[h]);
                f.push(b),
                c.data("chips", f),
